...
Course: IST 242
Author: Mike Cliggett
Date Developed: 3/14/19
Last Date Changed: 6/9/19
Rev: 2
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Menu menu1 = new Menu(1, "Plain",10.99);
        Menu menu2 = new Menu(2, "Meat", 13.99);
        Menu menu3 = new Menu(3, "Extra", 15.99);
        Menu menu4 = new Menu(4, "Veg", 12.99);
        ...
        while (userAction != EXIT_CODE) {
            switch(userAction) {
                ...
                case MENU_CODE : Menu.listMenu(mList);
                    break;
                case ORDE_CODE : Order.printOrder(oList);
                    break;
